...
function AddBook() {
  ...
  // State variable to manage the open/close state of the select menu
  ...
  const genreChangeHandler = (event) => {
    ...
    setSelectOpen(false); // Close the select menu after selection
  };
    ...
    <form onChange={addBookHandler} onSubmit={postHandler}>
      ...
      >
        ...
        <Select
          ...
          onOpen={() => setSelectOpen(true)} // Open the select menu
          onClose={() => setSelectOpen(false)} // Close the select menu
          open={selectOpen} // Control the open/close state of the select menu
